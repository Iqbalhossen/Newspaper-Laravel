...
class ReporterController extends Controller
{
    ...
    public function NewsManage(){
        ...
        $news = News::latest()->where('userId',$userId)->where('status',1)->get();
        return view('backend.reporter.news.manage_news',compact('news'));
    }

    public function PenddingManage(){
        $userId = session('loggedInUser');
        $news = News::latest()->where('userId',$userId)->where('status',3)->get();
        return view('backend.reporter.news.pendding_news',compact('news'));
    }
    public function UnApproved(){
        $userId = session('loggedInUser');
        $news = News::latest()->where('userId',$userId)->where('status',4)->get();
        return view('backend.reporter.news.unapproved_news',compact('news'));
    }
    ...
    public function AddNews(){
        ...
        return view('backend.reporter.news.add_news',compact('category','subCategory','division','district','userId'));
    }
    ...
    public function StoreNews(Request $request){
        ...
        return redirect()->route('reporter.pendding.Manage')->with($notification);
    }
    ...
    public function EditNews($id,$slug){
        ...
        return view('backend.reporter.news.edit_news',compact('news', 'category', 'subCategory', 'division', 'district'));

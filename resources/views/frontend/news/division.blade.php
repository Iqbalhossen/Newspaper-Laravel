                            ...
                            @foreach($news as $items)
                                ...
                                <div class="post sports-post post-separator-border col-md-4 col-12">
                                    <div class="post-wrap">
                                        ...
                                        <!-- Image -->
                                        <a class="image" href="{{url('/details',$items->id.'/'.$items->slug)}}"><img src="{{ asset($items->imageThum) }}" alt="post"></a>

                                        <!-- Content -->
                                        <div class="content">

                                            <!-- Title -->
                                            <h4 class="title"><a href="{{url('/details',$items->id.'/'.$items->slug)}}">{{$items->title}}</a></h4>
                                            ...
                                            <!-- Description -->
                                            <p>{!! Str::limit($items->newsDetailsOne, 100 )  !!}</p>

                                            <!-- Read More -->
                                            <a href="{{url('/details',$items->id.'/'.$items->slug)}}" class="read-more">continue reading</a>

    ...
    <div class="post-header-section section mt-30 mb-30">
        <div class="container">
            <div class="row row-1">
                ...
                <!-- Page Banner Start -->
                <div class="col-12">
                    <div class="post-header" style="background-image: url({{asset('frontend/assets/img/bg/page-banner-fashion.jpg')}})">
                        ...
                        <!-- Meta -->
                        <div class="meta fix">
                            <a href="#" class="meta-item category fashion">{{$news['categoryShow']['categoryName']}}</a>

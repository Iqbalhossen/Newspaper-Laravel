            ...
            <li class="user-dropdown">
                <div class="dropdown">
                    <button class="btn dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img src="{{ asset('admin/assets/images/user.jpg') }}" alt="" class="img-fluid">
                    </button>
                    <div class="dropdown-menu dropdown_user" aria-labelledby="dropdownMenuButton" >
                        <div class="dropdown-header d-flex flex-column align-items-center">
                            <div class="user_img mb-3">
                                <img src="{{ asset('admin/assets/images/user.jpg') }}" alt="User Image">
                            </div>
                        ...
                        <a class="dropdown-item" href=""><i class="ti-user"></i>Change Profile</a>
                      
                        <a class="dropdown-item" href=""><i class="ti-user"></i>Change Password</a>
                        <span role="separator" class="divider"></span>
                        <a class="dropdown-item" href="{{url('admin/logout')}}"><i class="ti-power-off"></i>Logout</a>
                    </div>
                </div>
            </li>
        </ul>

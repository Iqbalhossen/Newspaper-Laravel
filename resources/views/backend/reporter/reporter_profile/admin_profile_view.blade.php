                                    ...
                                    <div class="col-md-12">
                                        <div class="media-left">
                                            <a href="#" class="profile-image">
                                                <img class="user-img img-radius" src="../assets/images/team/member2.jpg" alt="user-img">
                                            </a>
                                        </div>
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><a href="#!">{{$adminData->email}}</a></td>
                                                                </tr>
                                                                <tr>
                                                    ...
                                                    <div class="isotopeContainer">
                                                        ...
                                                        <div class="portfolio_grid grid no-padding isotopeSelector webdesign grid-item">
                                                            <figure class="effect-chico">
                                                                <img src="../assets/images/portfolio/bw1.jpg" alt="Portfolio"/>
                                                                <figcaption>
                                                                    <h3>
                                                                        <a href="javascript:void(0);" class="view_proj">Portfolio Item</a>
                                                                        <span>
                                                                <a href="../assets/images/portfolio/bw1.jpg" class="fancybox open_img"><i class="ion-ios-plus-empty"></i></a>
                                                            </span>
                                                                    </h3>
                                                        ...
                                                        <div class="portfolio_grid grid no-padding isotopeSelector webdesign grid-item">
                                                            <figure class="effect-chico">
                                                                <img src="../assets/images/portfolio/bw3.jpg" alt="Portfolio"/>
                                                                <figcaption>
                                                                    <h3>
                                                                        <a href="javascript:void(0);" class="view_proj">Portfolio Item</a>
                                                                        <span>
                                                                <a href="../assets/images/portfolio/bw3.jpg" class="fancybox open_img"><i class="ion-ios-plus-empty"></i></a>
                                                            </span>
                                                                    </h3>
                                                        ...
                                                        <div class="portfolio_grid grid no-padding isotopeSelector marketing grid-item">
                                                            <figure class="effect-chico">
                                                                <img src="../assets/images/portfolio/bw4.jpg" alt="Portfolio"/>
                                                                <figcaption>
                                                                    <h3>
                                                                        <a href="javascript:void(0);" class="view_proj">Portfolio Item</a>
                                                                        <span>
                                                                <a href="../assets/images/portfolio/bw4.jpg" class="fancybox open_img"><i class="ion-ios-plus-empty"></i></a>
                                                            </span>
                                                                    </h3>
                                                        ...
                                                        <div class="portfolio_grid grid no-padding isotopeSelector webdesign grid-item">
                                                            <figure class="effect-chico">
                                                                <img src="../assets/images/portfolio/bw5.jpg" alt="Portfolio"/>
                                                                <figcaption>
                                                                    <h3>
                                                                        <a href="javascript:void(0);" class="view_proj">Portfolio Item</a>
                                                                        <span>
                                                                <a href="../assets/images/portfolio/bw5.jpg" class="fancybox open_img"><i class="ion-ios-plus-empty"></i></a>
                                                            </span>
                                                                    </h3>
                                                        ...
                                                        <div class="portfolio_grid grid no-padding isotopeSelector webdevelopment grid-item">
                                                            <figure class="effect-chico">
                                                                <img src="../assets/images/portfolio/bw7.jpg" alt="Portfolio"/>
                                                                <figcaption>
                                                                    <h3>
                                                                        <a href="javascript:void(0);" class="view_proj">Portfolio Item</a>
                                                                        <span>
                                                                <a href="../assets/images/portfolio/bw7.jpg" class="fancybox open_img"><i class="ion-ios-plus-empty"></i></a>
                                                            </span>
                                                                    </h3>
                                                        ...
                                                        <div class="portfolio_grid grid no-padding isotopeSelector webdevelopment grid-item">
                                                            <figure class="effect-chico">
                                                                <img src="../assets/images/portfolio/bw8.jpg" alt="Portfolio"/>
                                                                <figcaption>
                                                                    <h3>
                                                                        <a href="javascript:void(0);" class="view_proj">Portfolio Item</a>
                                                                        <span>
                                                                <a href="../assets/images/portfolio/bw8.jpg" class="fancybox open_img"><i class="ion-ios-plus-empty"></i></a>
                                                            </span>
                                                                    </h3>
                                                        ...
                                                        <div class="portfolio_grid grid no-padding isotopeSelector marketing grid-item">
                                                            <figure class="effect-chico">
                                                                <img src="../assets/images/portfolio/bw9.jpg" alt="Portfolio"/>
                                                                <figcaption>
                                                                    <h3>
                                                                        <a href="javascript:void(0);" class="view_proj">Portfolio Item</a>
                                                                        <span>
                                                                <a href="../assets/images/portfolio/bw9.jpg" class="fancybox open_img"><i class="ion-ios-plus-empty"></i></a>
                                                            </span>
                                                                    </h3>
                                                        ...
                                                        <div class="portfolio_grid grid no-padding isotopeSelector marketing grid-item">
                                                            <figure class="effect-chico">
                                                                <img src="../assets/images/portfolio/bw10.jpg" alt="Portfolio"/>
                                                                <figcaption>
                                                                    <h3>
                                                                        <a href="javascript:void(0);" class="view_proj">Portfolio Item</a>
                                                                        <span>
                                                                <a href="../assets/images/portfolio/bw10.jpg" class="fancybox open_img"><i class="ion-ios-plus-empty"></i></a>
                                                            </span>
                                                                    </h3>
                                                                </figcaption>
                                                            </figure>

                                ...
                                <table id="dataTable" class="text-center">
                                   ...
                                   @foreach($news as $key => $items)
                                    <tr>
                                        ...
                                        <td width="25%">
                                        <a href="{{url('reporter/news/edit',$items->id.'/'.$items->slug)}}"  title="Edit" class="btn btn-success"><i class="fas fa-edit mr-1" ></i></a>
                                        <a href=""  title="Show" class="btn btn-info"><i class="fas fa-eye mr-1" ></i></a>
                                        <a href="{{url('reporter/news/delete',$items->id.'/'.$items->slug)}}" id="delete"  title="Delete" class="btn btn-danger"><i class="fas fa-trash-alt" ></i></a>
                                        </td>
                                    </tr>
                                    @endforeach  
                                    </tbody>
